export default {
  ...
  strings: {
    ...
    LINK_URL_TIP: '<strong>Tip!</strong> Link text should always be clear, unique, and meaningful so it could be understood out of context.',
    ...
    FILE_TYPE_WARNING_TIP: '<strong>Example:</strong> Executive Report (PDF, 3MB)',
    ...
    LINK_ALT_HAS_SUS_WORD_MESSAGE_INFO: 'The alt text for this image is: <strong>%(altText)</strong>',
    ...
    LINK_IMAGE_LINK_ALT_TEXT_MESSAGE_INFO: 'Alt text: <strong>%(altText)</strong>',
    ...
    LINK_IMAGE_PLACEHOLDER_ALT_MESSAGE: 'Non-descript or placeholder alt text within a linked image found. Ensure the alt text describes the destination of the link, not a literal description of the image. Replace the following alt text: <strong>%(altText)</strong>.',
    LINK_IMAGE_SUS_ALT_MESSAGE: 'Assistive technologies already indicate that this is an image, so &quot;<strong>%(error)</strong>&quot; or &quot;%(error) of&quot; may be redundant. Ensure the alt text describes the destination of the link, not a literal description of the image.',
    ...
    // Contrast
    CONTRAST_ERROR_INPUT_MESSAGE: 'The text within this input does not have enough contrast with the background. The contrast ratio should be at least 4.5:1 for normal text and 3:1 for large text.',
    CONTRAST_ERROR_INPUT_MESSAGE_INFO: 'The contrast ratio is <strong>%(cratio)</strong>.',
    ...
    CONTRAST_ERROR_MESSAGE_INFO: 'The contrast ratio is <strong>%(cratio)</strong> for the following text: <strong>%(nodetext)</strong>',
    ...
    CONTRAST_WARNING_MESSAGE_INFO: 'Please review contrast of the following text:<br><strong>%(nodetext)</strong>',
